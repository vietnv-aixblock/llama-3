...
def run_inference(args):
    ...
    dist.init_process_group(args.backend, init_method='tcp://{master_addr}:{master_port}', rank=args.rank,
...
def run_predict(args):
    run_inference(args)
    mp.spawn(run_inference, args=(args), nprocs=args.world_size * torch.cuda.device_count(), join=True)
